...
public:
     ...
     void ekranKomutMesaj(QString baslik,QString mesaj)
     {
         ...
         QRect desktopScreenSize = screen->availableGeometry();
         ...
         this->repaint();
         QPalette palet;
         palet.setBrush(QPalette::Window, QColor(100,100,100,100));
     ...
     void ekranMesaj(QString baslik,QString mesaj)
    {
       ...
       //this->setStyleSheet("background-color: #a3acac");
        ...
        this->repaint();
        QPalette palet;
        palet.setBrush(QPalette::Window, QColor(163,172,172,255));
        this->setPalette(palet);  //setZeminColor(myZeminColor);
     ...
     void ekranTransparanKilit()
    {
        ...
        this->repaint();
        QPalette palet;
        palet.setBrush(QPalette::Window, QColor(0,0,0,1));
        this->setPalette(palet);  //setZeminColor(myZeminColor);
