...
Q_CONSTINIT static const qt_meta_stringdata_CaptureThread_t qt_meta_stringdata_CaptureThread = {
    {
        ...
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 10),  // "MediaFrame"
        QT_MOC_LITERAL(37, 5),  // "frame"
        QT_MOC_LITERAL(43, 5),  // "error"
        QT_MOC_LITERAL(49, 4),  // "text"
        QT_MOC_LITERAL(54, 15),  // "audioFrameReady"
        QT_MOC_LITERAL(70, 10),  // "AudioFrame"
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->audioFrameReady((*reinterpret_cast< std::add_pointer_t<AudioFrame>>(_a[1]))); break;
        ...
        {
            using _t = void (CaptureThread::*)(const MediaFrame & );
        ...
        {
            using _t = void (CaptureThread::*)(const AudioFrame & );
            if (_t _q_method = &CaptureThread::audioFrameReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::frameReady(const MediaFrame & _t1)
{
...
// SIGNAL 2
void CaptureThread::audioFrameReady(const AudioFrame & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
