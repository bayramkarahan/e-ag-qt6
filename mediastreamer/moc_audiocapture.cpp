...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AudioCapture_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AudioCapture_t qt_meta_stringdata_AudioCapture = {
    {
        QT_MOC_LITERAL(0, 12),  // "AudioCapture"
        QT_MOC_LITERAL(13, 10),  // "frameReady"
        QT_MOC_LITERAL(24, 0),  // ""
        QT_MOC_LITERAL(25, 10),  // "AudioFrame"
        QT_MOC_LITERAL(36, 5),  // "frame"
        QT_MOC_LITERAL(42, 8)   // "readData"
    },
    "AudioCapture",
    "frameReady",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_AudioCapture[] = {
...
Q_CONSTINIT const QMetaObject AudioCapture::staticMetaObject = { {
    ...
    qt_meta_stringdata_AudioCapture.offsetsAndSizes,
    qt_meta_data_AudioCapture,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AudioCapture_t,
        // Q_OBJECT / Q_GADGET
...
void AudioCapture::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AudioCapture::*)(const AudioFrame & );
            if (_t _q_method = &AudioCapture::frameReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioCapture::frameReady(const AudioFrame & _t1)
{
