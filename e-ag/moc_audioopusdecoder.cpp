...
#include <memory>
#include "streamplayer/decoder/audioopusdecoder.h"
...
Q_CONSTINIT static const uint qt_meta_data_AudioOpusDecoder[] = {
 ...
 // slots: parameters
    QMetaType::Void, QMetaType::QByteArray, QMetaType::LongLong,    6,    7,
...
void AudioOpusDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->decode((*reinterpret_cast< std::add_pointer_t<QByteArray>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<qint64>>(_a[2]))); break;
        default: ;
        }
