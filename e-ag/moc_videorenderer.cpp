...
#include <memory>
#include "streamplayer/renderer/videorenderer.h"
...
namespace {
struct qt_meta_stringdata_VideoRenderer_t {
    uint offsetsAndSizes[2];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_VideoRenderer_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_VideoRenderer_t qt_meta_stringdata_VideoRenderer = {
    {
        QT_MOC_LITERAL(0, 13)   // "VideoRenderer"
    },
    "VideoRenderer"
};
...
Q_CONSTINIT static const uint qt_meta_data_VideoRenderer[] = {
...
Q_CONSTINIT const QMetaObject VideoRenderer::staticMetaObject = { {
    ...
    qt_meta_stringdata_VideoRenderer.offsetsAndSizes,
    qt_meta_data_VideoRenderer,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_VideoRenderer_t,
        // Q_OBJECT / Q_GADGET
...
void *VideoRenderer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoRenderer.stringdata0))
