...
#include <memory>
#include "streamplayer/player/audioprocessor.h"
...
namespace {
struct qt_meta_stringdata_AudioProcessor_t {
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AudioProcessor_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AudioProcessor_t qt_meta_stringdata_AudioProcessor = {
    {
        QT_MOC_LITERAL(0, 14),  // "AudioProcessor"
...
Q_CONSTINIT static const uint qt_meta_data_AudioProcessor[] = {
...
Q_CONSTINIT const QMetaObject AudioProcessor::staticMetaObject = { {
    ...
    qt_meta_stringdata_AudioProcessor.offsetsAndSizes,
    qt_meta_data_AudioProcessor,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AudioProcessor_t,
        // Q_OBJECT / Q_GADGET
...
void AudioProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onFrame((*reinterpret_cast< std::add_pointer_t<AudioFrame>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (AudioProcessor::*)(const AudioFrame & );
            if (_t _q_method = &AudioProcessor::frameReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *AudioProcessor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AudioProcessor.stringdata0))
...
// SIGNAL 0
void AudioProcessor::frameReady(const AudioFrame & _t1)
{
