#ifndef VAAPIVIDEODECODER_H
#define VAAPIVIDEODECODER_H
...
class VaapiVideoDecoder : public AbstractVideoDecoder
{
    Q_OBJECT

public:

    explicit VaapiVideoDecoder(QObject *parent = nullptr);
